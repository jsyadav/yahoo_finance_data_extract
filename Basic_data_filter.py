...
class InfoBasicFilter(object):
    ...
    def __init__(self, fname):
        ...
        self.criteria_folder_path = r'.\criteria'
        ...
        self.modified_raw_file_path = r'C:\Users\JSYADAV\PycharmProjects\yahoo_finance_data_extract\data\stockpick'
    ...
    def load_criteria_type_dict(self):
        ...
        self.criteria_type_path_dict = {os.path.splitext(f)[0]: os.path.join(mypath, f) for f in os.listdir(mypath) if
    ...
    def __print_criteria_info(self, criteria_type, *criteria_list):
        ...
        """
        print
        "Current Screen criteria: ", criteria_type, ' ', ','.join(criteria_list)
    ...
    def print_full_filter_on_criteria_type(self):
        ...
        print
        "List of filter for the criteria: ", self.criteria_type
        print
        '-' * 40
        for n in ['greater', 'less', 'compare']:
            ...
            if n == 'greater':
                for sub_n in sub_criteria_dict.keys():
                    print
                    sub_n, ' > ', sub_criteria_dict[sub_n][0]
            ...
            if n == 'compare':
                for sub_n in sub_criteria_dict.keys():
                    ...
                    if not len(param_list) == 4:
                        print
                        'Something wrong with compare criteria: ', param_list
                        continue
                    print
                    param_list[0], param_list[2], param_list[1], param_list[3]
    ...
    def print_all_availiable_criteria(self):
        ...
        """
        print
        self.criteria_type_path_dict.keys()
    ...
    def process_criteria(self):
        ...
        print ('greater' in self.criteria_dict)
    ...
    def loop_criteria(self):
        ...
        for n in self.criteria_type_path_dict.keys():
            if self.use_subset_criteria_list:
                if not n in self.sub_set_criteria_list:
                    continue
...
if __name__ == '__main__':
    ...
    if choice == 1:
        print
        ss = InfoBasicFilter(r'C:\Users\JSYADAV\PycharmProjects\yahoo_finance_data_extract\data\temp\stock_data.csv')
