...
class XlsExtractor(object):
    ...
    def open_excel_and_process_block_data(self):
        ...
        try:
            ...
            if not self.header_key_tag == '':
                ...
                self.header_list = \
                self.get_raw_block_fr_xls(header_start_add_row - 1, header_start_add_col + 1, header_start_add_row,
                                          no_of_header_cols - 1)[0]
    ...
    def convert_table_to_df(self):
        ...
        if not len(self.full_filtered_data[0]) == len(self.header_list):
    ...
    def get_raw_block_fr_xls(self, start_address_row, start_address_col, end_address_row, num_of_col):
        ...
        """
        dataset = self.excel_obj.getrange(self.sheetname, (
        start_address_row + 1, start_address_col, end_address_row, start_address_col + num_of_col))
    ...
    def get_header_fr_xls(self):
        ...
        try:
            ...
            self.header_list = \
            self.get_raw_block_fr_xls(start_address_row - 1, start_address_col + 1, start_address_row,
                                      no_of_header_cols - 1)[0]
...
if __name__ == '__main__':
    ...
    if 9 in test:
        """"""
        xls_set_class = XlsExtractor(fname=r'C:\Python27\Lib\site-packages\excel_table_extract\testset.xls',
                                     sheetname='Sheet1',
    ...
    if 10 in test:
        ...
        try:
            ...
            s = xls_set_class.get_raw_block_fr_xls(start_address_row, start_address_col, end_address_row,
                                                   xls_set_class.col_len)
            print(s)
            ...
            print(xls_set_class.close_excel())
